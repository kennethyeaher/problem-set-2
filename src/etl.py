...
def run_etl():
    #  create data direcotry id it doen't exist
    os.makedirs('data', exist_ok=True)

    # extract, getting read datasets from dropbox
    ...
    # transfrom, convert filling date to datetime, rename, drop orginal 
    ...
    print(f"pred_universe_raw: {pred_universe_raw.shape}")
    print(f"arrest_events_raw: {arrest_events_raw.shape}")
